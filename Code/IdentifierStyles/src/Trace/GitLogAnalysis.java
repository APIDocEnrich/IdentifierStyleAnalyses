...
import DS.MethodDS;
import ParseInfo.ClassCollector;
import ParseInfo.VariableCollector;
...
//        	System.out.println(onepackage.toString());
        	...
        	{
        		System.err.println("1"+identifiername+"  "+singlestate);
        	}
...
//        	System.out.println(onetype.toString());
        	...
        	{
        		System.err.println("2"+identifiername+"  "+singlestate);
        	}
        ...
        for(IdentifierDS onemethod:methods)
        {
        	...
        	{
        		System.err.println("3"+identifiername+"  "+singlestate);
        	}
        }
        for(IdentifierDS onefield:fields)
        {
        	...
        	{
        		System.err.println("4"+identifiername+"  "+singlestate);
        	}
        }
	...
	//        		purelocation=location+1;
	        		...
	        		{
	        			System.err.println("5"+identifiername+"  "+singlestate);
	        		}
        		}
        	}
        }
